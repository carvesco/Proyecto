...
public class ControlMovimiento {
    ...
    private void memorizando(String cmd){
        switch (cmd){
            case "Primero":
                System.arraycopy(BotonSelecionado, 0, MemoricBoton, 0, 5); 
                break;
            case "Segundo":
                System.arraycopy(BotonSelecionado, 0, MemoricBoton, 5, 4); 
                break;
            case "Tercero":
                System.arraycopy(BotonSelecionado, 0, MemoricBoton, 9, 3);  
                break;
            case "Cuarto":
                System.arraycopy(BotonSelecionado, 0, MemoricBoton, 12, 2); 
                break;
            case "Quinto":
                System.arraycopy(BotonSelecionado, 0, MemoricBoton, 14, 5);
                break;
            case "Sexto":
                System.arraycopy(BotonSelecionado, 0, MemoricBoton, 19, 4); 
                break;
            case "Septimo":
                System.arraycopy(BotonSelecionado, 0, MemoricBoton, 23, 3); 
                break;
            case "Octavo":
                System.arraycopy(BotonSelecionado, 0, MemoricBoton, 26, 2); 
                break;
            case "Noveno":
