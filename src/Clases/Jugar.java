...
public class Jugar {
    ...
    public JButton MemoricBoton[];
    public JButton MemoricBase[];
    public JButton BotonMapa[];
    public JButton BotonBase[];
    public JButton cptBarco1[], cptBarco2[], cptBarco3[], cptBarco4[], cptBarco5[], cptBarco6[], cptBarco7[], cptBarco8[], cptBarco9[], cptBarco10[];
    public JButton miBarco1[], miBarco2[], miBarco3[], miBarco4[], miBarco5[], miBarco6[], miBarco7[], miBarco8[], miBarco9[], miBarco10[];
    public boolean computerbarcoundido[];
    public boolean mibarcoundido[];
    public boolean Terminar = false;
    public boolean MiTurno = true;
    public Juego juego;
    public BarcosEnemigos clase;
    public JButton MiTiro[] = new JButton[225];
    public JButton ComputadoraTiro[] = new JButton[225];
    public int t1 = 0, t2 = 0, time = 0;
    ...
    public String Nivel;
    public JButton NivelEscogido[];
    public int TiroRecorrido = 0;
    public Sonido sonido = new Sonido();
    public int turnosplayer = 10;
    public int turnospc = 3;
    ...
    private void TiroComputadora() throws IOException, FileNotFoundException, InterruptedException {
        for(int i = 0; i < turnospc; i++) {
    ...
    private void MostrarSiMeDio(JButton tiro) throws IOException, FileNotFoundException, InterruptedException {
    ...
    private void MostrarsileDi(JButton tiro) throws IOException, FileNotFoundException, InterruptedException {
    ...
    private void MiBarcoUndido() throws IOException, FileNotFoundException, InterruptedException {
        if (!mibarcoundido[0]) {
    ...
    private void VerificarBarcoUndido(int x, int y) throws IOException, FileNotFoundException, InterruptedException {
    ...
    private void ComputerBarcoUndido() throws IOException, FileNotFoundException, InterruptedException {
